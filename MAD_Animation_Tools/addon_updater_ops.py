...
class ATAddonUpdaterInstallPopup(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        if updater.manual_only:
            ...
            atr = ATAddonUpdaterInstallPopup.bl_idname.split(".")
...
class ATAddonUpdaterCheckNow(bpy.types.Operator):
...
class ATAddonUpdaterUpdateNow(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        if updater.update_ready:
            ...
            try:
                ...
                updater.print_trace()
                atr = ATAddonUpdaterInstallManually.bl_idname.split(".")
                getattr(getattr(bpy.ops, atr[0]), atr[1])('INVOKE_DEFAULT')
        elif updater.update_ready is None:
...
class ATAddonUpdaterUpdateTarget(bpy.types.Operator):
...
class ATAddonUpdaterInstallManually(bpy.types.Operator):
...
class ATAddonUpdaterUpdatedSuccessful(bpy.types.Operator):
...
class ATAddonUpdaterRestoreBackup(bpy.types.Operator):
...
class ATAddonUpdaterIgnore(bpy.types.Operator):
...
class ATAddonUpdaterEndBackground(bpy.types.Operator):
...
def updater_run_success_popup_handler(scene):
    ...
    atr = ATAddonUpdaterUpdatedSuccessful.bl_idname.split(".")
    getattr(getattr(bpy.ops, atr[0]), atr[1])('INVOKE_DEFAULT')
...
def update_settings_ui(self, context, element=None):
    ...
    if updater.error is not None:
        ...
        if "ssl" in updater.error_msg.lower():
            split.enabled = True
            split.operator(ATAddonUpdaterInstallManually.bl_idname,
                           text=updater.error)
        else:
            split.enabled = False
            split.operator(ATAddonUpdaterCheckNow.bl_idname,
                           text=updater.error)
        split = sub_col.split(align=True)
        split.scale_y = 2
        split.operator(ATAddonUpdaterCheckNow.bl_idname,
        ...
        col.scale_y = 2
        col.operator(ATAddonUpdaterCheckNow.bl_idname)
        ...
        split.enabled = False
        split.scale_y = 2
        split.operator(ATAddonUpdaterCheckNow.bl_idname, text="Checking...")
        split = sub_col.split(align=True)
        split.scale_y = 2
        split.operator(ATAddonUpdaterEndBackground.bl_idname, text="", icon="X")
        ...
        split.operator(ATAddonUpdaterUpdateNow.bl_idname, text=update_now_txt)
        split = sub_col.split(align=True)
        split.scale_y = 2
        split.operator(ATAddonUpdaterCheckNow.bl_idname,
                       text="", icon="FILE_REFRESH")
        ...
        split = sub_col.split(align=True)
        split.scale_y = 2
        split.operator(ATAddonUpdaterUpdateNow.bl_idname,
    ...
    if not updater.manual_only:
        ...
        if updater.include_branches and len(updater.include_branch_list) > 0:
            ...
            col.operator(ATAddonUpdaterUpdateTarget.bl_idname,
        ...
        col.operator(ATAddonUpdaterRestoreBackup.bl_idname, text=backup_text)
...
def update_settings_ui_condensed(self, context, element=None):
    ...
    if updater.error is not None:
        ...
        split.operator(ATAddonUpdaterUpdateNow.bl_idname, text=now_txt)
        split = sub_col.split(align=True)
        split.scale_y = 2
        split.operator(ATAddonUpdaterCheckNow.bl_idname,
                       text="", icon="FILE_REFRESH")
...
# -----------------------------------------------------------------------------
classes = (
    ATAddonUpdaterInstallPopup,
    ATAddonUpdaterCheckNow,
    ATAddonUpdaterUpdateNow,
    ATAddonUpdaterUpdateTarget,
    ATAddonUpdaterInstallManually,
    ATAddonUpdaterUpdatedSuccessful,
    ATAddonUpdaterRestoreBackup,
    ATAddonUpdaterIgnore,
    ATAddonUpdaterEndBackground
)
